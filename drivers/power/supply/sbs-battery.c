...
static const struct chip_data {
	...
	[REG_MAX_ERROR] =
		SBS_DATA(POWER_SUPPLY_PROP_MAX_ERROR, 0x0C, 0, 100),
	[REG_CAPACITY] =
	...
	[REG_BATTERY_STATUS] = 
		SBS_DATA(POWER_SUPPLY_PROP_BATTERY_STATUS, 0x16, 0, 0xFFFF),
	[REG_SPEC_INFO] = 
		SBS_DATA(POWER_SUPPLY_PROP_SPEC_INFO, 0x1a, 0, 0xFFFF),
};
...
#define TEMP_KELVIN_TO_CELSIUS		2731
	...
	case POWER_SUPPLY_PROP_MANUFACTURE_DATE:
		...
		val->intval = mktime64(((val->intval & 0xFE00) >> 9) + 1980,/* year */
	...
	union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_MAX_ERROR:
	...
	case POWER_SUPPLY_PROP_MANUFACTURE_DATE:
	case POWER_SUPPLY_PROP_SPEC_INFO:
